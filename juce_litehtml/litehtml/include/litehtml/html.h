...
namespace litehtml
{
	...
	public:
		...
		virtual void				link(const std::shared_ptr<litehtml::document>& doc, const std::shared_ptr<litehtml::element>& el) = 0;
		virtual void				on_anchor_click(const litehtml::tchar_t* url, const std::shared_ptr<litehtml::element>& el) = 0;
